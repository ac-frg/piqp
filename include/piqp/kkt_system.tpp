...
// Tag dispatch helpers for extract_P_diag
template<typename T, typename I>
void extract_P_diag_impl(const dense::Data<T>& data, Vec<T>& P_diag, std::integral_constant<int, PIQP_DENSE>)
{
	P_diag.noalias() = data.P_utri.diagonal();
}

template<typename T, typename I>
void extract_P_diag_impl(const sparse::Data<T, I>& data, Vec<T>& P_diag, std::integral_constant<int, PIQP_SPARSE>)
{
...
// Tag dispatch helpers for init_kkt_solver
template<typename T, typename I>
bool init_kkt_solver_impl(const dense::Data<T>& data, const Settings<T>& settings,
                          std::unique_ptr<KKTSolverBase<T, I, PIQP_DENSE>>& kkt_solver,
                          std::integral_constant<int, PIQP_DENSE>)
{
...
template<typename T, typename I>
bool init_kkt_solver_impl(const sparse::Data<T, I>& data, const Settings<T>& settings,
                          std::unique_ptr<KKTSolverBase<T, I, PIQP_SPARSE>>& kkt_solver,
                          std::integral_constant<int, PIQP_SPARSE>)
{
	switch (settings.kkt_solver) {
...
KKTSystem<T, I, MatrixType>::KKTSystem(const KKTSystem& other) :
	m_rho(other.m_rho),
...
// init
template<typename T, typename I, int MatrixType>
bool KKTSystem<T, I, MatrixType>::init(const DataType& data, const Settings<T>& settings)
{
	...
	return init_kkt_solver(data, settings);
}

// update_data
template<typename T, typename I, int MatrixType>
void KKTSystem<T, I, MatrixType>::update_data(const DataType& data, int options)
{
...
// update_scalings_and_factor
template<typename T, typename I, int MatrixType>
bool KKTSystem<T, I, MatrixType>::update_scalings_and_factor(const DataType& data, const Settings<T>& settings, bool iterative_refinement,
...
// solve
template<typename T, typename I, int MatrixType>
bool KKTSystem<T, I, MatrixType>::solve(const DataType& data, const Settings<T>& settings, const Variables<T>& rhs, Variables<T>& lhs)
{
...
// eval_P_x
template<typename T, typename I, int MatrixType>
void KKTSystem<T, I, MatrixType>::eval_P_x(const DataType& data, const T& alpha, const Vec<T>& x, Vec<T>& z)
{
...
// eval_A_xn_and_AT_xt
template<typename T, typename I, int MatrixType>
void KKTSystem<T, I, MatrixType>::eval_A_xn_and_AT_xt(const DataType& data, const T& alpha_n, const T& alpha_t, const Vec<T>& xn, const Vec<T>& xt, Vec<T>& zn, Vec<T>& zt)
{
...
// eval_G_xn_and_GT_xt
template<typename T, typename I, int MatrixType>
void KKTSystem<T, I, MatrixType>::eval_G_xn_and_GT_xt(const DataType& data, const T& alpha_n, const T& alpha_t, const Vec<T>& xn, const Vec<T>& xt, Vec<T>& zn, Vec<T>& zt)
{
...
// mul
template<typename T, typename I, int MatrixType>
void KKTSystem<T, I, MatrixType>::mul(const DataType& data, const Variables<T>& lhs, Variables<T>& rhs)
{
...
// print_info
template<typename T, typename I, int MatrixType>
void KKTSystem<T, I, MatrixType>::print_info()
{
	kkt_solver->print_info();
}

// extract_P_diag
template<typename T, typename I, int MatrixType>
void KKTSystem<T, I, MatrixType>::extract_P_diag(const DataType& data)
{
	detail::extract_P_diag_impl<T, I>(data, P_diag, std::integral_constant<int, MatrixType>{});
}

// init_kkt_solver
template<typename T, typename I, int MatrixType>
bool KKTSystem<T, I, MatrixType>::init_kkt_solver(const DataType& data, const Settings<T>& settings)
{
	return detail::init_kkt_solver_impl<T, I>(data, settings, kkt_solver, std::integral_constant<int, MatrixType>{});
}

// inf_norm
template<typename T, typename I, int MatrixType>
T KKTSystem<T, I, MatrixType>::inf_norm(const Vec<T>& x, const Vec<T>& y, const Vec<T>& z)
{
...
// mul_condensed_kkt
template<typename T, typename I, int MatrixType>
void KKTSystem<T, I, MatrixType>::mul_condensed_kkt(const DataType& data,
...
// get_refine_error
template<typename T, typename I, int MatrixType>
T KKTSystem<T, I, MatrixType>::get_refine_error(const DataType& data,
	              const Vec<T>& lhs_x, const Vec<T>& lhs_y, const Vec<T>& lhs_z,
