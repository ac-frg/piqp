...
template<typename T, typename I>
std::unique_ptr<KKTSolverBase<T, I, PIQP_SPARSE>> MultistageKKT<T, I>::clone() const
{
    return std::make_unique<MultistageKKT>(*this);
}

template<typename T, typename I>
void MultistageKKT<T, I>::update_data(const Data<T, I>& data, int options)
{
...
template<typename T, typename I>
bool MultistageKKT<T, I>::update_scalings_and_factor(const Data<T, I>&, const T& delta, const Vec<T>& x_reg, const Vec<T>& z_reg)
{
    m_delta = delta;
...
template<typename T, typename I>
void MultistageKKT<T, I>::solve(const Data<T, I>&, const Vec<T>& rhs_x, const Vec<T>& rhs_y, const Vec<T>& rhs_z, Vec<T>& lhs_x, Vec<T>& lhs_y, Vec<T>& lhs_z)
{
...
// z = alpha * P * x
template<typename T, typename I>
void MultistageKKT<T, I>::eval_P_x(const Data<T, I>&, const T& alpha, const Vec<T>& x, Vec<T>& z)
{
...
template<typename T, typename I>
void MultistageKKT<T, I>::eval_A_xn_and_AT_xt(const Data<T, I>&, const T& alpha_n, const T& alpha_t, const Vec<T>& xn, const Vec<T>& xt, Vec<T>& zn, Vec<T>& zt)
{
...
template<typename T, typename I>
void MultistageKKT<T, I>::eval_G_xn_and_GT_xt(const Data<T, I>&, const T& alpha_n, const T& alpha_t, const Vec<T>& xn, const Vec<T>& xt, Vec<T>& zn, Vec<T>& zt)
{
    BlockVec& block_xn = work_x_block_1;
...
template<typename T, typename I>
void MultistageKKT<T, I>::print_info()
{
    std::size_t N = block_info.size();
...
template<typename T, typename I>
usize MultistageKKT<T, I>::flops_gemm(usize m, usize n, usize k)
{
    return 2 * m * n * k;
}
...
template<typename T, typename I>
usize MultistageKKT<T, I>::flops_trsm(usize m, usize n)
{
    return m * m * n;
}
...
template<typename T, typename I>
usize MultistageKKT<T, I>::flops_syrk(usize n, usize k)
{
    return n * n * k;
}
...
// chol(A), C \in R^{n x n}
template<typename T, typename I>
usize MultistageKKT<T, I>::flops_potrf(size_t n)
{
    return n * n * n / 3;
}

template<typename T, typename I>
void MultistageKKT<T, I>::extract_arrow_structure(const Data<T, I>& data)
{
...
template<typename T, typename I>
void MultistageKKT<T, I>::utri_to_kkt(const SparseMat<T, I>& A_utri, BlockKKT& A_kkt)
{
    std::size_t N = block_info.size();
...
template<typename T, typename I>
template<bool init>
void MultistageKKT<T, I>::transpose_to_block_mat(const SparseMat<T, I>& sAT, bool store_transpose, BlockMat<I>& A_block)
{
...
template<typename T, typename I>
void MultistageKKT<T, I>::block_syrk_ln_alloc(BlockMat<I>& sA, BlockMat<I>& sB, BlockKKT& sD)
{
...
template<typename T, typename I>
void MultistageKKT<T, I>::block_syrk_ln_calc(BlockMat<I>& sA, BlockMat<I>& sB, BlockKKT& sD)
{
...
void MultistageKKT<T, I>::block_syrk_ln(BlockMat<I>& sA, BlockMat<I>& sB, BlockKKT& sD)
{
    std::size_t N = block_info.size();
    I arrow_width = block_info.back().diag_size;
...
template<typename T, typename I>
void MultistageKKT<T, I>::init_kkt_fac()
{
...
template<typename T, typename I>
void MultistageKKT<T, I>::populate_kkt_fac(const Vec<T>& x_reg)
{
...
template<typename T, typename I>
template<bool allocate>
void MultistageKKT<T, I>::construct_kkt_fac(const Vec<T>& x_reg)
{
...
// sD = sA * diag(sB)
template<typename T, typename I>
void MultistageKKT<T, I>::block_gemm_nd(BlockMat<I>& sA, BlockVec& sB, BlockMat<I>& sD)
{
...
// z = alpha * sA * x
template<typename T, typename I>
void MultistageKKT<T, I>::block_symv_l(double alpha, BlockKKT& sA, BlockVec& x, BlockVec& z)
{
...
// z = alpha * sA * x
template<typename T, typename I>
void MultistageKKT<T, I>::block_symv_l_parallel(double alpha, BlockKKT& sA, BlockVec& x, BlockVec& z)
{
...
// y = alpha * x
template<typename T, typename I>
void MultistageKKT<T, I>::block_veccpsc(double alpha, BlockVec& x, BlockVec& y)
{
...
template<typename T, typename I>
void MultistageKKT<T, I>::block_t_gemv_n(double alpha, BlockMat<I>& sA, BlockVec& x, double beta, BlockVec& y, BlockVec& z)
{
...
template<typename T, typename I>
void MultistageKKT<T, I>::block_t_gemv_t(double alpha, BlockMat<I>& sA, BlockVec& x, double beta, BlockVec& y, BlockVec& z)
{
...
//     [A_{1,N} A_{2,N} A_{3,N}   ...      A_{N-4,N} A_{N-3,N} A_{N-2,N}    ]
template<typename T, typename I>
void MultistageKKT<T, I>::block_t_gemv_nt(double alpha_n, double alpha_t, BlockMat<I>& sA, BlockVec& x_n, BlockVec& x_t,
...
template<typename T, typename I>
void MultistageKKT<T, I>::solve_llt_in_place(BlockVec& b_and_x)
{
